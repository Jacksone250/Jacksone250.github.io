    ...
    .then(resultJSON => {
        ...
        towns.forEach(town => {
            if (town.name === 'Fish Haven') {
                ...
                document.querySelector('#pYear').textContent = town.yearFounded;
                document.querySelector('#pPop').textContent = town.currentPopulation;
                document.querySelector('#pRain').textContent = town.averageRainfall;
                ...
                document.querySelector('#ssYear').textContent = town.yearFounded;
                document.querySelector('#ssPop').textContent = town.currentPopulation;
                document.querySelector('#ssRain').textContent = town.averageRainfall;
